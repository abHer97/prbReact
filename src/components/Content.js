...
let url = 'https://siticl-apis-dev.azurewebsites.net/empresas/prueba/v1/catalogos/productores/';
		...
		<main className="container flex-grow mx-auto bg-white rounded-t flex">
			...
			<article className="w-4/6 px-6 py-4">
				...
				<div className="w-2/4 mb-4 flex">
					...
					<button onClick={handleBuscar} className="py-2 px-3 bg-gray-300 h-10 w-12 mt-auto">
